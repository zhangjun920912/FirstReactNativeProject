            ...
            <View>
                    <View style={{alignItems:'center'}}>
                        <View style={{
                            ...
                            <Text style={{width:(screenWeight-60)/8}}>{rangeValue[0]}</Text>
                            <Text style={{width:(screenWeight-60)/8,marginLeft:-6}}>{rangeValue[1]}</Text>
                            <Text style={{width:(screenWeight-60)/8}}>{rangeValue[2]}</Text>
                            <Text style={{width:(screenWeight-60)/8}}>{rangeValue[3]}</Text>
                            <Text style={{width:(screenWeight-60)/8}}>{rangeValue[4]}</Text>
                            <Text style={{width:(screenWeight-60)/8,marginLeft:-10}}>{rangeValue[5]}</Text>
                            <Text style={{width:(screenWeight-60)/8}}>{rangeValue[6]}</Text>
                            <Text style={{width:(screenWeight-60)/8}}>{rangeValue[7]}</Text>
                            <Text style={{width:(screenWeight-60)/8}}>{rangeValue[8]}</Text>
                        </View>
                        <View style={{
                            flexDirection:'row',
                            marginTop:8,
